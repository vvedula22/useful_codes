...
!         write(stdout,ftab1)
 ...
 001     write(stdout,ftab4) "ERROR: end of file reached.."
         ...
         case ("ImageData")
            call vtkParseImageData(vtk,dataArr,iatt,idata,istat)
            if ( istat.lt.0 ) return

         case ("RectilinearGrid")
            call vtkParseRectGrid(vtk,dataArr,iatt,idata,istat)
            if ( istat.lt.0 ) return

         case ("StructuredGrid")
            call vtkParseStrucGrid(vtk,dataArr,iatt,idata,istat)
            if ( istat.lt.0 ) return
         ...
         subroutine vtkParseImageData(vtk,dataArr,iatt,idata,istat)
         implicit none
         type(vtkXMLType), intent(inout) :: vtk
         type(dataArrType), intent(inout), target :: dataArr
         integer(IK), intent(in) :: iatt,idata
         ...
         subroutine vtkParseRectGrid(vtk,dataArr,iatt,idata,istat)
         implicit none
         type(vtkXMLType), intent(inout) :: vtk
         type(dataArrType), intent(inout), target :: dataArr
         integer(IK), intent(in) :: iatt,idata
         ...
         dPtr => dataArr
         write(stdout,ftab4) "ERROR: Rectilinear grid parser is not available.."
         istat = -1; return
         ...
         subroutine vtkParseStrucGrid(vtk,dataArr,iatt,idata,istat)
         implicit none
         type(vtkXMLType), intent(inout) :: vtk
         type(dataArrType), intent(inout), target :: dataArr
         integer(IK), intent(in) :: iatt,idata
 ...
 001     write(stdout,ftab4) "ERROR: end of file reached.."
         ...
         type(vtkXMLType), intent(inout) :: vtk
         integer(IK), intent(inout) :: istat
         integer(IK) :: fid,i,iatt,ivar,tmpI(100),ios
