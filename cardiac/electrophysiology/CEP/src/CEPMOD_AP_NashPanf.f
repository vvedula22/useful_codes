...
!        Nash, M. P., & Panfilov, A. V. (2004). Electromechanical model
!        of excitable tissue to study reentrant cardiac arrhythmias.
!        Progress in Biophysics and Molecular Biology, 85(2–3), 501–522.
!        https://doi.org/10.1016/j.pbiomolbio.2004.01.016
!
!-----------------------------------------------------------------------
